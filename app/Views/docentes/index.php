...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="bi bi-person-video"></i> Listado de Docentes</h1>
        <a href="<?php echo base_url('docentes/create');?>" class="btn btn-primary">
    ...
    <div class="mb-3">
        <form method="get" class="input-group">
            ...
            <?php if (!empty($search)): ?>
                <a href="<?php echo base_url('docentes');?>" class="btn btn-outline-secondary">
    ...
    <?php if (!empty($docentes)): ?>
        <div class="table-responsive">
            <table id="docentesTable" class="table table-striped table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <a href="<?php echo base_url('docentes/edit/' . $docente['id']);?>" 
                                       class="btn btn-warning" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="<?php echo base_url('docentes/delete/' . $docente['id']);?>" 
    ...
    <?php else: ?>
        <div class="alert alert-info" role="alert">
            <i class="bi bi-info-circle"></i> No hay docentes registrados. 
            <a href="<?php echo base_url('docentes/create');?>" class="alert-link">Crear uno ahora</a>
        </div>
    <?php endif;?>
</div>
